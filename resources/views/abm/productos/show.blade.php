    ...
    <div class="container">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @if ($producto->links)
                    <p class="card-text"><strong>Links:</strong> <a href="{{ $producto->links }}"
                            target="_blank">{{ $producto->links }}</a></p>
                @endif
                <p class="card-text"><strong>Código:</strong> {{ $producto->codigo }} - <strong>Unidad:</strong>
                    {{ $producto->unidad->nombre }}</p>
                <p class="card-text"><strong>Detalle:</strong> {{ $producto->detalle }}</p>
                <p class="card-text"><strong>Familia:</strong> {{ $producto->familia->nombre }} - <strong>Tipo:</strong>
                    {{ $producto->tipo->nombre }} - <strong>Activo:</strong> {{ $producto->activo ? 'Sí' : 'No' }}</p>
                <p class="card-text">
                    ...
                    <div class="row mt-3">
                        @if ($producto->img)
                            <div class="col-md-3 mb-3">
                                ...
                                <img src="{{ asset($producto->img) }}" alt="Imagen principal"
                                    class="img-thumbnail w-100 zoom-hover"
                                    onclick="showImageModal('{{ asset($producto->img) }}')">
                        ...
                        @if ($producto->img_1)
                            <div class="col-md-3 mb-3">
                                <h5>Imagen 2</h5>
                                <img src="{{ asset($producto->img_1) }}" alt="Imagen principal"
                                    class="img-thumbnail w-100 zoom-hover"
                                    onclick="showImageModal('{{ asset($producto->img_1) }}')">
                        ...
                        @if ($producto->img_2)
                            <div class="col-md-3 mb-3">
                                <h5>Imagen 3</h5>
                                <img src="{{ asset($producto->img_2) }}" alt="Imagen principal"
                                    class="img-thumbnail w-100 zoom-hover"
                                    onclick="showImageModal('{{ asset($producto->img_2) }}')">
                        ...
                        @if ($producto->img_3)
                            <div class="col-md-3 mb-3">
                                <h5>Imagen 4</h5>
                                <img src="{{ asset($producto->img_3) }}" alt="Imagen principal"
                                    class="img-thumbnail w-100 zoom-hover"
                                    onclick="showImageModal('{{ asset($producto->img_3) }}')">
                ...
                @if ($producto->potencia_requerida_hp)
                    <p class="card-text"><strong>Potencia Requerida (HP):</strong> {{ $producto->potencia_requerida_hp }}
                    </p>
                @endif
                ...
                @if ($producto->tiempo_descarga_aprx_min)
                    <p class="card-text"><strong>Tiempo de Descarga Aprox. (min):</strong>
                        {{ $producto->tiempo_descarga_aprx_min }}</p>
                @endif
