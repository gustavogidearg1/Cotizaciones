                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('forma-pagos.update', $formaPago) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="diferencia" type="number" step="0.01" class="form-control @error('diferencia') is-invalid @enderror" name="diferencia" value="{{ old('diferencia', $formaPago->diferencia) }}" required>
