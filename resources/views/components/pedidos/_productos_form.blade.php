    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="number" step="0.01" min="0" class="form-control precio-input"
                name="productos[{{ $index }}][precio]" value="{{ $subPedido->precio ?? 0 }}" required>
        </div>
    </div>
    ...
    <div class="col-md-1">
        <div class="form-group">
            ...
            <input type="number" min="1" class="form-control cantidad-input"
                name="productos[{{ $index }}][cantidad]" value="{{ $subPedido->cantidad ?? 1 }}" required>
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="number" step="0.01" min="0" max="100" class="form-control iva-input"
                name="productos[{{ $index }}][iva]" value="{{ $subPedido->iva ?? 21 }}" required>
        </div>
    </div>
    <div class="col-md-2">
        <div class="form-group">
...
<div class="row mt-2">
    <div class="col-md-12">
        <div class="form-group">
            <label>Detalle</label>
            <input type="text" class="form-control" name="productos[{{ $index }}][detalle]"
