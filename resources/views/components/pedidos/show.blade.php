...
<div class="container">
    <div class="card mb-4">
        <div class="card-header bg-orange text-white">
            <div class="row align-items-center">
                ...
                <div class="col-6 text-end">
                    <h2 class="mb-0">{{ $pedido->tipoPedido->nombre }} #{{ $pedido->id }}/ {{ $pedido->user->id }}</h2>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <p><strong>Fecha Necesidad a partir de la confirmacion del pedido:</strong> {{ \Carbon\Carbon::parse($pedido->fecha_necesidad)->format('d/m/Y') }}</p>
    ...
    @php
        ...
        function renderTable($subPedidos, $esAccesorio = false, &$totalCantidad, &$subtotal, &$ivaTotal, &$totalGeneral) {
